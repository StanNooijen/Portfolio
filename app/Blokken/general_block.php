...
class general_block_php
{
    public function render_public_block($block_id, $block_name, $position)
    {
        ...
        $general_entries = $entries->get('general', collect());

        $html_general = $this->generateHtml($general_entries);

        $general_count = $general_entries->count();
        $circles_html = $this->generateCirclesHtml($general_count);

        $html = '
            <div class="container" id="general">
                <div class="row align-start">
                    <div class="vertical-line"></div>
                    <div class="col align-center general">
                        <h1>General</h1>
                        '. $html_general .'
                    </div>
                    <div class="line-down">
